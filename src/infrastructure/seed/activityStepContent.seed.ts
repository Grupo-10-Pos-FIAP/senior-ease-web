...
const MULTIPLE_CHOICE_BY_STEP: Record<string, ActivityStepContent> = {
  "step-1-2": {
    ...
    options: [
      { id: "a", label: "Tentar aprender tudo de uma vez sem pausa" },
      { id: "b", label: "Começar com uma tarefa simples e pedir ajuda de alguém de confiança" },
  ...
  "step-2-3": {
    ...
    options: [
      { id: "a", label: "Clicar no link e enviar os dados para resolver rápido" },
      { id: "b", label: "Responder o e-mail com seu CPF e senha" },
      { id: "c", label: "Não clicar no link; acessar o app Meu INSS ou ligar para o 135" },
  ...
  "step-3-3": {
    ...
    options: [
      { id: "a", label: "Ligar sem testar nada para não perder tempo" },
      { id: "b", label: "Ficar de costas para a janela, sem luz no rosto" },
      { id: "c", label: "Deixar o volume no mínimo para não incomodar" },
      { id: "d", label: "Testar câmera e microfone com calma antes" },
    ],
    correctOptionId: "d",
  },
  "step-4-2": {
  ...
  "step-5-2": {
    ...
    options: [
      { id: "a", label: "Telefone e e-mail para contato" },
      { id: "b", label: "CPF completo e número da conta bancária" },
  ...
  "step-6-3": {
    ...
    options: [
      { id: "a", label: "Responder rápido, mesmo sem entender a pergunta" },
      { id: "b", label: "Ficar olhando para o chão durante toda a conversa" },
      { id: "c", label: "Olhar para a câmera e ouvir a pergunta até o fim antes de responder" },
  ...
  "step-7-2": {
    ...
    options: [
      { id: "a", label: "Qualquer link que chegar por mensagem de texto" },
      { id: "b", label: "Site que um desconhecido enviou no WhatsApp" },
      { id: "c", label: "Formulário em rede social que pede selfie e CPF" },
      { id: "d", label: "App Meu INSS ou agência oficial — nunca por link de SMS" },
    ],
    correctOptionId: "d",
  },
  "step-8-3": {
  ...
  "step-10-2": {
    ...
    options: [
      { id: "a", label: "Compartilhar imediatamente para ajudar os amigos" },
      { id: "b", label: "Comprar o remédio pelo link da mensagem" },
      { id: "c", label: "Verificar em site de saúde oficial ou perguntar ao médico" },
  ...
  "step-14-2": {
    ...
    options: [
      { id: "a", label: "Clicar rápido no link para não perder o benefício" },
      { id: "b", label: "Não clicar; abrir o app oficial ou ligar para o canal conhecido" },
  ...
  "step-15-2": {
    ...
    options: [
      { id: "a", label: "A data de nascimento" },
      { id: "b", label: "A palavra 'senha123'" },
      { id: "c", label: "Uma frase longa com letras, números e símbolos, só sua" },
  ...
  "step-16-2": {
    ...
    options: [
      { id: "a", label: "Um link curto enviado por desconhecido no WhatsApp" },
      { id: "b", label: "Um endereço com várias letras trocadas e números estranhos" },
      { id: "c", label: "Qualquer página que peça senha com urgência" },
      { id: "d", label: "Um site que termina em .gov.br" },
    ],
    correctOptionId: "d",
  },
  "step-17-2": {
  ...
  "step-18-2": {
    ...
    options: [
      { id: "a", label: "Baixar qualquer programa enviado por mensagem" },
      { id: "b", label: "Abrir o site oficial e conectar com o QR Code do seu celular" },
  ...
  "step-19-2": {
    ...
    options: [
      { id: "a", label: "Só depois de já ter enviado o Pix" },
      { id: "b", label: "Nunca — é melhor resolver sozinho sempre" },
      { id: "c", label: "Quando a mensagem pedir dinheiro, senha ou código com urgência" },
      { id: "d", label: "Depois de já ter passado a senha, só para conferir" },
    ],
    correctOptionId: "c",
  },
  "step-20-2": {
    ...
    options: [
      { id: "a", label: "Qualquer número que mandar mensagem pedindo amizade" },
      { id: "b", label: "Um site estrangeiro sem telefone claro" },
      { id: "c", label: "Um perfil anônimo de rede social" },
      { id: "d", label: "Familiar próximo, vizinho de confiança ou serviço de saúde conhecido" },
    ],
    correctOptionId: "d",
  },
  "step-21-2": {
  ...
  "step-22-2": {
    ...
    options: [
      { id: "a", label: "Guardar a senha colada no monitor do trabalho" },
      { id: "b", label: "Não compartilhar a senha e trocá-la se suspeitar de acesso estranho" },
  ...
  "step-23-2": {
    ...
    options: [
      { id: "a", label: "Aceitar tudo para o app funcionar mais rápido" },
      { id: "b", label: "Instalar o mesmo app por um link de SMS" },
      { id: "c", label: "Desconfiar e negar permissões que não fazem sentido" },
  ...
  "step-24-2": {
    ...
    options: [
      { id: "a", label: "Pagar imediatamente pelo link da mensagem" },
      { id: "b", label: "Passar a senha do banco para a pessoa 'ajudar'" },
      { id: "c", label: "Enviar foto do comprovante antigo para desconhecidos" },
      {
        id: "d",
  ...
  "step-26-2": {
    ...
    options: [
      { id: "a", label: "Em um grupo aberto do WhatsApp" },
      { id: "b", label: "Em backup da sua conta ou em um pendrive/computador de confiança" },
  ...
  switch (type) {
    ...
    case "multiple_choice":
      return {
        ...
        options: [
          { id: "a", label: "Clicar em qualquer link com urgência" },
          { id: "b", label: "Pedir ajuda a alguém de confiança antes de continuar" },
